...
{
    /// <summary>
    /// The converter class for quotes.
    /// </summary>
    internal sealed class QuoteConverter : BlockConverter
    {
        /// <summary>
        ...
        public override string Convert(LatexExpression expr)
        {
            ...
            return "<q>" + SequenceConverter.ConvertOutline(expr.Expressions[0], expr.Customization) + "</q>";
        }
    }

    /// <summary>
    /// The converter class for quotations.
    /// </summary>
    internal sealed class QuotationConverter : BlockConverter
    {
        /// <summary>
        /// Performs the conversion procedure.
        /// </summary>
        ...
        {
            if (expr.Expressions == null) return "";
            return "<blockquote>" + SequenceConverter.ConvertOutline(expr.Expressions[0], expr.Customization) + "</blockquote>";
        }
    }
}
